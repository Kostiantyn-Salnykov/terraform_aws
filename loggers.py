...
LOGGING_CONFIG: dict[str, typing.Any] = {
    ...
    "loggers": {
        "asyncio": {"level": logging.WARNING, "handlers": ["default_handler"], "propagate": False},
        "gunicorn": {"level": logging.WARNING, "handlers": ["default_handler"], "propagate": False},
        "uvicorn": {"level": logging.WARNING, "handlers": ["default_handler"], "propagate": False},
